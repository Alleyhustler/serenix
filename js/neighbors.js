const dragElement = (element, dragzoneone) => {
    let pos1 = 0,
      pos2 = 0,
      pos3 = 0,
      pos4 = 0;
...
//offsetTop property returns the top position relative to the parent
  ...
  const dragableone = document.getElementById("dragableone"),
    dragzoneone = document.getElementById("dragzoneone");

  dragElement(dragableone, dragzoneone);